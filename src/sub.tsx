...
function SubApp() {
    ...
    return (
        <div className="sub-App">
            <Link activeClass="active" to="sub-select" smooth={true} duration={700} className="sub-scroll">
                <div id="sub-top">
                    <ReactCanvasNest
            ...
            <div id="sub-select">
                ...
                {wolfNum ? (
                    <div id="input_name" className={classes.numberselect}>
                        ...
                        <br /><br />
                        <Link activeClass="active" to="sub-game" smooth={true} duration={700}>
                        ...
                        <React.Fragment>
                            ...
                            {isFinished ?
                                <div className="answer">
                                    ...
                                    <Link activeClass="active" to="sub-select" smooth={true} duration={700}>
